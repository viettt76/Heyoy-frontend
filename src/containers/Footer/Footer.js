        ...
        <div className={clsx('d-md-flex',styles['footer'])}>
            <div className={clsx('col-md-6')}>
                ...
                <div>
                    ...
                    <span>
                        <i className="fa-solid fa-location-dot"></i> &nbsp;Lô B4/D21, Khu đô thị mới Cầu Giấy, Phường Dịch
                        Vọng Hậu, Quận Cầu Giấy, Thành phố Hà Nội, Việt Nam
                    </span>
                    <span>
                        <i className="fa-solid fa-check"></i> &nbsp;ĐKKD số. 0106790291. Sở KHĐT Hà Nội cấp ngày 16/03/2015
                    </span>
                </div>
